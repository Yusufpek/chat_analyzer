...
import { createConnectionSlice, ConnectionSliceState } from "./connection";
import { createSelectedSlice, SelectedSliceState } from "./selected";

// Combined store state type
export type RootState = LoginSliceState & AgentsSliceState & ConversationsSliceState & MessagesSliceState & ConnectionSliceState & SelectedSliceState;
